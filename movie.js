...
const APILINK = 'https://d406f9e7-b496-4f32-9f23-98f50753b6b2-00-2pb4u50hymn09.worf.repl.co/api/v1/reviews/';
  ...
  fetch(url + "movie/" + movieId)
    ...
    .then(function(data) {
      ...
      data.forEach(review => {
        ...
        div_card.innerHTML = `<div class="row">
              <div class="column">
...
function saveReview(reviewInputId, userInputId, id) {
  ...
  if (id) {
    ...
    fetch(APILINK + "new", {
      ...
      .then(() => returnReviews(APILINK)); // Update reviews after saving
  }
}
